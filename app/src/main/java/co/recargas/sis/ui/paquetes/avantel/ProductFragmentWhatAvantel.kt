...
class ProductFragmentWhatAvantel:Fragment() {
    ...
    override fun onCreateView(
        ...
        if(view is RecyclerView){
            ...
            //Observado
            productViewModel.getProductWhatAvantel().observe(viewLifecycleOwner, Observer {
                productos=it
    ...
    companion object{
        ...
        fun newInstance(columnCount:Int)=ProductFragmentWhatAvantel().apply {
