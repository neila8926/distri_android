...
class ProductFragmentMovistarTodoInc : Fragment() {
    ...
    override fun onCreateView(
        ...
        productViewModel.getProductTodoIncMovistar().observe(viewLifecycleOwner, Observer {
            productos= it
    ...
    companion object {
        ...
        fun newInstance(columnCount: Int) =
            ProductFragmentMovistarTodoInc().apply {
