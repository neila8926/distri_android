...
class ProductFragmentVirginBolsaWha: Fragment() {
    ...
    override fun onCreateView(
        ...
        productViewModel.getProductWhatsapp().observe(viewLifecycleOwner, Observer {
            productos=it
    ...
    companion object{
        ...
        fun newInstance(columnCount: Int)=ProductFragmentVirginBolsaWha().apply {
